...
public class AddImageToExistingPDFFile {
	...
	public static void addImageToExistingPDFFile() throws IOException {
		// Open a document
		Document pdfDocument1 = new Document("/Users/wuttichai/Desktop/TestJavaPdf/Examples/src/main/resources/DocumentConversion/input.pdf");
		// Set coordinates
		int lowerLeftX = 100;
		int lowerLeftY = 100;
		int upperRightX = 200;
		int upperRightY = 200;
		// Test page Count by Wut Dev
	...
	//	Rectangle rectangle = new Rectangle(lowerLeftX, lowerLeftY, upperRightX, upperRightY);
		...
		for (int pageCount = 1; pageCount <= 3; pageCount++) {
			// Get the Number PDF 
			int pageNumber = pdfDocument1.getPages().get_Item(pageCount).getNumber();
			//System.out.println("Page # -" + pageCount + " is Black and white.." + pageNumber);

			// Get the page you want to add the image to
			Page page = pdfDocument1.getPages().get_Item(pageNumber);
			// Load image into stream
			java.io.FileInputStream imageStream = new java.io.FileInputStream(new java.io.File("/Users/wuttichai/Desktop/input_image1.jpg"));
		...
		// Save the new PDF
		pdfDocument1.save("/Users/wuttichai/Desktop/TestJavaPdf/Examples/Updated_document.pdf");
	...
	public static void addingImageFromBufferedImageIntoPDF() throws IOException {
		BufferedImage originalImage = ImageIO.read(new File("/Users/wuttichai/Desktop/input_image1.jpg"));
